#ifndef _SPACEX_CONFIG_H_
#define _SPACEX_CONFIG_H_
...
public:
    ...
    std::string chain_address;      /* The address of spacex chain account */
    std::string chain_account_id;   /* The account id(hex string) of spacex chain account */
    std::string chain_password;     /* The password of spacex chain account */
    std::string chain_backup;       /* The backup of spacex chain account */
