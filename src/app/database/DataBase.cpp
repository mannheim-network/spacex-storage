...
DataBase *DataBase::get_instance()
{
    ...
    if (database == NULL)
    {
        ...
        if (SPACEX_SUCCESS != create_directory(p_config->db_path))
        {
            return NULL;
        }
 ...
 * @return: Add status
 */
spacex_status_t DataBase::add(std::string key, std::string value)
{
    std::string old_val;
    ...
    if (!s.ok())
    {
        ...
        return SPACEX_PERSIST_ADD_FAILED;
    }
 ...
 */
spacex_status_t DataBase::del(std::string key)
{
    ...
    if (!s.ok())
    {
        ...
        return SPACEX_PERSIST_DEL_FAILED;
    }
 ...
 * @return: Get status
 */
spacex_status_t DataBase::get(std::string key, std::string &value)
{
