...
// For ocall store
typedef spacex_status_t (*ocall_store2_f)(const uint8_t *u, size_t s);
typedef spacex_status_t (*ecall_store2_f)(const uint8_t *u, size_t s);
typedef sgx_status_t (*ocall_get2_f)(spacex_status_t *status, uint8_t *u, size_t s, size_t *rs);

// For all
#define XSTORAGE_VERSION "1.1.0"
