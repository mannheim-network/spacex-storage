...
sgx_status_t Ecall_srd_increase_test(sgx_enclave_id_t eid, spacex_status_t *status, const char *uuid);
...
sgx_status_t Ecall_get_file_info(sgx_enclave_id_t eid, spacex_status_t *status, const char *data);
sgx_status_t Ecall_gen_upgrade_data_test(sgx_enclave_id_t eid, spacex_status_t *status, size_t block_height);
sgx_status_t Ecall_gen_and_upload_work_report_test(sgx_enclave_id_t eid, spacex_status_t *status, const char *block_hash, size_t block_height);
