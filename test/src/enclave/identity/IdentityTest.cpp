...
spacex_status_t id_gen_upgrade_data_test(size_t block_height)
{
    ...
    if (SPACEX_SUCCESS != (spacex_status = gen_and_upload_work_report_test(report_hash, report_height, random_time, false, false)))
    {
